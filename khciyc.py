...
class Fenetre_Gestion_Datasets(ctk.CTkToplevel):
    def __init__(self, master=None):
        ...
        self.lbl_dataset_status.grid(row=3, column=0, padx=10, pady=(0, 10), sticky="w")
    ...
    def Ajouter_Dataset(self):
        ...
        try:
            ...
            self.lbl_dataset_status.configure(
                text=f"Dataset chargé avec succès :\n{file_path}",
                text_color="green"
            )
            ...
            self.lbl_dataset_status.configure(
                text="❌ Structure du dataset invalide",
                text_color="red"
            )
