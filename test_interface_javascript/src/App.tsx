...
type MainTab = 'architecture' | 'training' | 'testing' | 'metrics' | 'prediction';
type SidebarTab = 'data' | 'save' | 'model' | 'train' | 'time';
    ...
    <div className="h-screen flex flex-col bg-gradient-to-br from-slate-800 to-slate-900">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-80 bg-gradient-to-b from-slate-800/90 to-slate-900/90 border-r border-slate-700 flex flex-col backdrop-blur-sm">
          {/* Onglets sidebar : Data, Save, Model, Train, Time */}
        ...
        <main className="flex-1 flex flex-col overflow-hidden">
          {/* Onglets principaux : Architecture, Training, Testing, Metrics, Prediction */}
